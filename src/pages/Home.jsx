    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-[#faf7f2]/60 max-w-xl mx-auto mb-12">
          ¿Tienes preguntas sobre las clases? ¿Quieres saber si soy el profesor adecuado para ti? Escríbeme o llámame — ¡estoy aquí para ayudarte!
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-lg mx-auto">
          <a
            href="tel:+5491195209898"
            className="group flex flex-col items-center gap-3 bg-[#faf7f2]/5 hover:bg-[#d9582a] border border-[#faf7f2]/10 hover:border-[#d9582a] rounded-2xl p-6 transition-all duration-200"
            aria-label="Llamar al 11-95209-8958"
          >
            <svg className="w-8 h-8 text-[#efa47f] group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
            </svg>
            <div>
              <div className="text-xs font-semibold uppercase tracking-widest text-[#c69a44] group-hover:text-white/70 transition-colors mb-1">Teléfono</div>
